...
✨ Why this framework stands out
  ...
  ⚡ Auto-waiting built in
      Zero flaky tests — Playwright waits for elements to be ready automatically
  🏗️ Page Object Model
      Clean, reusable, maintainable structure following industry best practices
  🔴 Negative test cases
      Intentional failure scenarios that prove the pipeline is actually gatekeeping quality
  🔁 Jenkins CI/CD pipeline
      GitHub-integrated Jenkinsfile — auto-triggers tests on every push.
  📊 HTML test report
